...
export default class NotifService {
  constructor(onRegister, onNotification) {
    ...
    console.log('why', onNotification);
  ...
  localNotif(soundName) {
    ...
    PushNotification.localNotification({
      ...
      actions: ['하루 마치기'], // (Android only) See the doc for notification actions to know more
      ...
      title: 'Plan Maker', // (optional)
      message: '오늘 하루는 어떠셨나요?', // (required)
